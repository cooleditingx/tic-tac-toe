...
<p align="center"><img src="https://socialify.git.ci/cooleditingx/tic-tac-toe/image?custom_language=JavaScript&amp;font=KoHo&amp;language=1&amp;name=1&amp;owner=1&amp;pattern=Transparent&amp;stargazers=1&amp;theme=Dark" alt="project-image"></p>

<p id="description">A classic Tic-Tac-Toe game built with vanilla HTML CSS and JavaScript. This project provides a clean responsive interface for two players to compete locally. The game tracks turns validates moves and declares a winner or a draw.</p>

<h2>🚀 Demo</h2>

[https://cooleditingx.github.io/tic-tac-toe/](https://cooleditingx.github.io/tic-tac-toe/)
...
1.  The game begins with "Player 1 Turn". Player 1 uses the 'X' mark.
2.  Click on an empty square on the board to place your mark.
3.  The turn then switches to Player 2, who uses the 'O' mark.
